var highScoreList = document.querySelector("#leaderboard-table");
var backButton = document.querySelector("#return-to-game");
var clearScores = document.querySelector("#clear-leaderboard");
...
clearScores.addEventListener("click", function () {
    clearAll();
    window.location.href = "leadboards.html";
})
